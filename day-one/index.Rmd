...
This presentation is also available as a <a href="https://chris-gaskell.github.io/uos-sced/day-one/output/day-one.pdf">pdf</a> and <a href="https://chris-gaskell.github.io/uos-sced/day-one/output/day-one.pptx">powerpoint</a>
...
.left[.white[
.Large[Q. Why is change (across treatment) important?]

.Large[Q. What are the ways in which we can demonstrate if change has occured?]

.Large[Q. What are the implications of not attempting to establish if change has occured?]

.Large[Q. What is my relationship to outcome measurement, questionnaires, assessments etc.?]]]
